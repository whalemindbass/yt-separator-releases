...
- Windows installer (`Setup.exe`) and portable executable (`Portable.exe`)
- Auto-update manifests (`latest.yml`)
- ONNX model files (`htdemucs_core.onnx`, `htdemucs_6s.onnx`)

© 2026 Whale Mind. All rights reserved.
